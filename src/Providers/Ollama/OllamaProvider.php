...
final class OllamaProvider extends AbstractProvider
{
    ...
    {
        return $this->config->baseUri ?? 'http://localhost:11434/v1';
    }
    ...
    public function generateObject(
        ...
        $systemPrompt = "You must respond with valid JSON matching this schema: " . json_encode($jsonSchema);
    ...
    public function embed(string $model, string|array $input): array
    {
        ...
        $response = $this->request('embeddings.create', '/embeddings', [
            'model' => $model,
            'input' => $texts,
        ]);
